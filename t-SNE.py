...
ax = sns.scatterplot(features_tsne2[:,0], features_tsne2[:,1], hue=labels.T, palette=palette)
plt.legend(custom, ['Coag. mono', 'Coag. bi', 'Cutting', 'Haemolock', 'Table up',
                    'Table down', 'Table tilt', 'Table forth', 'Phone', 'DaVinci', 'Idle'])
...
plt.legend(custom, ['Coag. mono', 'Coag. bi', 'Cutting', 'Hämolock', 'Table up',
                    'Table down', 'Table tilt','Table forth', 'Phone', 'DaVinci', 'Idle'])
